    ...
    <section className="bg-white pb-12 md:pb-20 pt-4 px-6 sm:px-12">
      <div className="max-w-[1600px] mx-auto grid lg:grid-cols-2 gap-24 items-center">
        ...
        <div>
          ...
          <p className="text-gray-700 text-subheading leading-relaxed mb-6 max-w-2xl">
          ...
          <p className="text-gray-700 text-subheading leading-relaxed mb-12 max-w-2xl">
          ...
          <button onClick={scrollToPricing} className="inline-block bgPinkGradient px-10 py-5 rounded-full text-white font-semibold text-para hover:opacity-90 transition cursor-pointer">
        ...
        {/* Right Column: Breakdown Info */}
              <div className="bg-[#f9f9f9] rounded-3xl shadow-2xl p-12 sm:p-16">
                  ...
                  <p className="text-gray-700 text-subheading leading-relaxed mb-6">
                  ...
                  <p className="text-gray-700 text-subheading leading-relaxed">
