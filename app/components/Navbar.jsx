...
export default function Navbar() {
  ...
  return (
    <nav className="flex justify-between items-center px-8 py-4 shadow-md bg-white relative z-50 ">
      <div className="text-xl font-bold">CLEVEROAD</div>
      ...
      <ul className="hidden lg:flex text-gray-700 font-medium text-[18px]">
        <div className="flex gap-[26px] items-center">
          ...
          <li>
            <Link href="#">
              <button className="bg-[#0066FF] text-white px-[23px] py-[17px] rounded-[100px] text-[18px] hover:bg-blue-700 font-[500px]">
                Contact us
              </button>
            </Link>
          </li>
      ...
      {menuOpen && (
        <ul className="lg:hidden absolute top-full left-0 w-full bg-white px-6 py-4 shadow-md flex flex-col gap-4 text-gray-700 font-medium text-[18px]">
          ...
          <li>
            <Link href="#">
              <button className="bg-[#0066FF] text-white px-[23px] py-[14px] rounded-[100px] text-[18px] hover:bg-blue-700 w-full">
                Contact us
              </button>
            </Link>
          </li>
