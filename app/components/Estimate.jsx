  ...
  return (
    <div className='container '>
      <div className="flex xl:flex-row flex-col overflow-hidden max-w-[1260px] xl:mx-auto mx-4 pt-16 gap-8 xl:gap-0">
        ...
        <div className="xl:w-3/4 bgGray rounded-[18px] pt-[40px] pb-[50px] px-[20px] sm:px-[40px] lg:px-[104px] w-full">
          <p className='leading-[38px] text-[20px] sm:text-[28px]  pb-[40px]'>Rough Estimate of My App</p>
          <div className='flex overflow-hidden max-w-[730px] mx-auto text-white rounded-[18px] flex-col lg:flex-row'>
            ...
            <div className='lg:w-2/5 bg-[#174273] pt-[60px] px-[60px] pb-[95px] flex flex-col justify-center items-center'>
