        ...
        <section className="container py-[102px] text-center px-4">
            <div className="bgGray pt-[40px] pb-[95px] rounded-[18px] max-w-[1260px] mx-auto ">
                ...
                <div className="flex justify-center lg:gap-[26px] lg:flex-row flex-col gap-[50px] px-4 lg:px-2 ">
                    <div className="bgBlue text-white pt-[47px] px-[76px] rounded-xl max-w-[507px] flex flex-col items-center justify-center lg:mx-0 mx-auto group overflow-hidden">
                        ...
                        <img src="/Home/mobile.svg" alt="App Preview" 
                        className="transition-transform duration-300 group-hover:scale-105"
                        />
                    </div>
                    <Link href="/pricing">
                        <div className="bgPink text-white rounded-xl max-w-[507px] pt-[47px] px-[88px] lg:mx-0 mx-auto group overflow-hidden">
                            ...
                            <img src="/Home/purse.png" alt="Business Preview"
                                className="transition-transform duration-300 group-hover:scale-105"
                            />
                        </div>
                    </Link>
